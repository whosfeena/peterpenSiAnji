...
class MhsUpdateJadwal extends StatefulWidget {
  final String title;
  const MhsUpdateJadwal({Key key,this.title}) : super(key: key);

  @override
  _MhsUpdateJadwalState createState() => _MhsUpdateJadwalState();
}

class _MhsUpdateJadwalState extends State<MhsUpdateJadwal> {
    ...
    return new Scaffold(
      ...
      body: Form(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
              children: <Widget>[
                Text('Anda Akan Mengajukan Jadwal Janjian Sesuai Jadwal yang Dimiliki Dosen',
                ...
                MaterialButton(
                  ...
                  onPressed: () {
                    return showDialog(
                      ...
                      builder: (context){
                        return AlertDialog(
                          title: Text("Update Jadwal Janjian"),
                          content: Text(" Apakah anda akan menperbarui data ini?"),
                          actions: <Widget>[
                            FlatButton(
                              onPressed: () async{
