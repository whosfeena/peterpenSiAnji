...
class FormMhsBuatJadwal extends StatefulWidget {
  ...
  Dosen dosen;
  Mahasiswa mhs;
  FormMhsBuatJadwal({Key key, this.title, this.janjian, this.dosen, this.nim, this.mhs}) : super(key: key);


  @override
  _FormMhsBuatJadwalState createState() => _FormMhsBuatJadwalState(title,janjian,dosen,nim,mhs);
}
...
class _FormMhsBuatJadwalState extends State<FormMhsBuatJadwal> {
  ...
  _FormMhsBuatJadwalState(this.title, this.janjian, this.dosen, this.nim, this.mhs);
